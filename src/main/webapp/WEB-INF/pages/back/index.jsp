...
<!--<link rel="stylesheet" type="text/css" media="screen" href="../Source_UNMINIFIED_${wx}/smart/css/smartadmin-production.css">-->
<!--<link rel="stylesheet" type="text/css" media="screen" href="../Source_UNMINIFIED_${wx}/smart/css/smartadmin-skins.css">-->
...
<body class="smart-style-0">
		...
		<div class="ajax-dropdown">
			...
			<div class="btn-group btn-group-justified" data-toggle="buttons">
				<label class="btn btn-default"> <input type="radio"
					name="activity" id="${wx}/smart/ajax/notify/mail.html"> Msgs (14)
				</label> <label class="btn btn-default"> <input type="radio"
					name="activity" id="${wx}/smart/ajax/notify/notifications.html"> notify
					(3)
				</label> <label class="btn btn-default"> <input type="radio"
					name="activity" id="${wx}/smart/ajax/notify/tasks.html"> Tasks (4)
				</label>
			</div>
	...
	<!-- end projects dropdown --> <!-- #TOGGLE LAYOUT BUTTONS --> <!-- pulled right: nav area -->
	<div class="pull-right">
		...
		<ul id="mobile-profile-img"
			...
			<li class=""><a href="#"
				...
				data-toggle="dropdown"> <img src="${wx}/smart/img/avatars/sunny.png"
				...
				<ul class="dropdown-menu pull-right">
					...
					<li class="divider"></li>
					<li><a href="#${wx}/smart/ajax/profile.html"
						class="padding-10 padding-top-0 padding-bottom-0"> <i
		...
		<!-- #SEARCH -->
		<!-- input: search field -->
		<form action="#${wx}/smart/ajax/search.html" class="header-search pull-right">
		...
		<ul class="header-dropdown-list hidden-xs">
			<li><a href="#" class="dropdown-toggle" data-toggle="dropdown">
					<img src="${wx}/smart/img/blank.gif" class="flag flag-us" alt="United States">
					<span> US</span> <i class="fa fa-angle-down"></i>
			</a>
				<ul class="dropdown-menu pull-right">
					<li class="active"><a href="javascript:void(0);"><img
							src="${wx}/smart/img/blank.gif" class="flag flag-us" alt="United States">
							English (US)</a></li>
					<li><a href="javascript:void(0);"><img src="${wx}/smart/img/blank.gif"
	...
	<div class="login-info">
		<span> <!-- User image size is adjusted inside CSS, it should stay as is -->
			...
			data-action="toggleShortcut"> <img src="${wx}/smart/img/avatars/sunny.png"
				alt="me" class="online" /> <span> shen </span> <i
	...
	<ul>
		<li class=""><a href="#" title="Dashboard"><i
			...
			<ul>
				<li><a href="${wx}/mk/order">Order</a>
				</li>
				<li><a href="${wx}/mk/product">Coupon</a>
				</li>
			</ul></li>
	</ul>
	</nav> 
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6">
				<span class="txt-color-white">SmartAdmin 1.8.2 <span
					class="hidden-xs"> - Web Application Framework</span> © 2014-2016
				</span>
			</div>
	...
	<div id="shortcut">
		<ul>
			<li><a href="#${wx}/smart/ajax/inbox.html"
			...
			<li><a href="#${wx}/smart/ajax/gallery.html"
	...
	<!-- PACE LOADER - turn this on if you want ajax loading to show (caution: uses lots of memory on iDevices)
		<script data-pace-options='{ "restartOnRequestAfter": true }' src="${wx}/smart/js/plugin/pace/pace.min.js"></script>-->
	...
	<script>
			if (!window.jQuery) {
				document.write('<script src="${wx}/smart/js/libs/jquery-2.1.1.min.js"><\/script>');
			}
		</script>
	...
	<script>
			if (!window.jQuery.ui) {
				document.write('<script src="${wx}/smart/js/libs/jquery-ui-1.10.3.min.js"><\/script>');
			}
		</script>
	...
	<!-- CUSTOM NOTIFICATION -->
	<script src="${wx}/smart/js/notification/SmartNotification.min.js"></script>

	<!-- JARVIS WIDGETS -->
	<script src="${wx}/smart/js/smartwidgets/jarvis.widget.min.js"></script>

	<!-- EASY PIE CHARTS -->
	<script src="${wx}/smart/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js"></script>

	<!-- SPARKLINES -->
	<script src="${wx}/smart/js/plugin/sparkline/jquery.sparkline.min.js"></script>
	...
	<script src="${wx}/smart/js/plugin/select2/select2.min.js"></script>

	<!-- JQUERY UI + Bootstrap Slider -->
	<script src="${wx}/smart/js/plugin/bootstrap-slider/bootstrap-slider.min.js"></script>

	<!-- browser msie issue fix -->
	<script src="${wx}/smart/js/plugin/msie-fix/jquery.mb.browser.min.js"></script>

	<!-- FastClick: For mobile devices: you can disable this in app.js -->
	<script src="${wx}/smart/js/plugin/fastclick/fastclick.min.js"></script>
	...
	<!-- Demo purpose only -->
	<script src="${wx}/smart/js/demo.min.js"></script>
	...
	<script src="${wx}/smart/js/speech/voicecommand.min.js"></script>

	<!-- SmartChat UI : plugin -->
	<script src="${wx}/smart/js/smart-chat-ui/smart.chat.ui.min.js"></script>
	<script src="${wx}/smart/js/smart-chat-ui/smart.chat.manager.min.js"></script>
