...
public class WxMenuController implements WxMpMenuService {
	...
	public String menuCreateSample() throws WxErrorException {
		...
		button1.setName("卡券说明");
		button1.setUrl("http://www.cnmokazu.com/coupon.jsp");
		WxMenuButton button2 = new WxMenuButton();
		button2.setType(WxConsts.BUTTON_VIEW);
		button2.setName("旗舰店铺");
		button2.setUrl("http://www.cnmokazu.com/shop.jsp");
		WxMenuButton button3 = new WxMenuButton();
		button3.setType(WxConsts.BUTTON_VIEW);
		button3.setName("卡券购买");
		button3.setUrl("http://www.cnmokazu.com/buy.jsp");
